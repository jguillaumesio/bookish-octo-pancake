...
module.exports = () => {
    ...
    module.downloadList = async (socket, downloads) => {
        try{
            ...
            logError("socket/game.controller.js",e);
        }
    }
    ...
    module.restartDownload = async (url, directory, name, socket, downloads) => {
        try{
            ...
            let content = JSON.parse(fs.readFileSync(`${directory}/${process.env.INFORMATIONS_FILENAME}`, 'utf8'));
            ...
            content = JSON.parse(fs.readFileSync(`${directory}/${process.env.INFORMATIONS_FILENAME}`, 'utf8'));
            delete content["chunks"];
            fs.writeFileSync(`${directory}/${process.env.INFORMATIONS_FILENAME}`, JSON.stringify({
                ...content,
                "state": "downloaded"
